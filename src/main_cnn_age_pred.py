...
if __name__ == '__main__':
    ...
    model_encoder = models.AlexNet2D_Dropout(num_classes=1).to(opts.device)
    ...
    # training 
    train_loss = []
    wandb.init(project='openbhb_cdae_0601_alex_1', dir='/scratch_net/murgul/jiaxia/saved_models')
    config = wandb.config
    ...
    for epoch in range(0, opts.epochs):
        ...
        if epoch == 29:
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch30.pth')
        if epoch == 49:
            checkpoint = {
                'epoch': epoch,
                'model_encoder_state_dict': model_encoder.state_dict(),
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch50.pth')
        ...
        if epoch == 99:
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch100.pth')
        if epoch == 149:
            checkpoint = {
                'epoch': epoch,
                'model_encoder_state_dict': model_encoder.state_dict(),
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch150.pth')
        if epoch == 199:
            checkpoint = {
                'epoch': epoch,
                'model_encoder_state_dict': model_encoder.state_dict(),
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch200.pth')
        if epoch == 249:
            checkpoint = {
                'epoch': epoch,
                'model_encoder_state_dict': model_encoder.state_dict(),
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch250.pth')
        if epoch == 299:
            checkpoint = {
                'epoch': epoch,
                'model_encoder_state_dict': model_encoder.state_dict(),
            ...
            torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2_epoch300.pth')
    ...
    torch.save(checkpoint, '/scratch_net/murgul/jiaxia/saved_models/cnn_0525_2.pth')
