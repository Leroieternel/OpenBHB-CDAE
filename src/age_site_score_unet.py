...
if __name__ == "__main__":
    ...
    model_unet = models.UNet(n_channels=1, n_classes=1)
    ...
    optimizer = torch.optim.RMSprop(model_unet.parameters(), lr=1e-4)
    ...
    model_unet = model_unet.to(device='cuda')
    ...
    checkpoint = torch.load('/scratch_net/murgul/jiaxia/saved_models/unet_100_0124_mse_bs4_0410.pth', map_location=device)
    ...
    ba_train, ba_int = compute_site_ba(model_unet, train_loader_score, test_loader_int, test_loader_ext, opts)
