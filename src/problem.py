...
def get_train_data(path="/usr/bmicnas02/data-biwi-01/bmicdatasets-originals/Originals/openBHB/brain_age_with_site_removal-main"):
    """ Get openBHB public train set.
    """
    return _read_data(path, "train")


def get_test_data(path="/usr/bmicnas02/data-biwi-01/bmicdatasets-originals/Originals/openBHB/brain_age_with_site_removal-main"):
...
class DatasetHelper(object):
    ...
    def plot_data(self, data, sample_id, channel_id, hemi="left"):
        ...
        if dtype in ("vbm", "quasiraw"):
            print('data[sample_id, channel_id].shape: ', data[sample_id, channel_id].shape)
